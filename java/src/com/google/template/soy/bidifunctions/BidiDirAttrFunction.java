 ...
 */
@Singleton
class BidiDirAttrFunction implements SoyJavaFunction, SoyJsSrcFunction, SoyPySrcFunction, SoyPhpSrcFunction {
  ...
  @Override public PhpExpr computeForPhpSrc(List<PhpExpr> args) {
    ...
    String callText =
            "Bidi::dirAttr(" + bidiGlobalDirProvider.get().getCodeSnippet() + ", " +
                    value.getText() + (isHtml != null ? ", " + isHtml.getText() : "") + ")";
