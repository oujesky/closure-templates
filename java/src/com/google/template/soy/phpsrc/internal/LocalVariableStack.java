 ...
 * to their respective PHP expressions. It enables scoped resolution of variables in places
 * such as inside function calls and loops.
 */
final class LocalVariableStack {

    private final Deque<Map<String, PhpExpr>> localVarExprs = new ArrayDeque<>();
     ...
     */
    void pushFrame() {
        localVarExprs.push(new HashMap<String, PhpExpr>());
    }
     ...
     */
    LocalVariableStack addVariable(String name, PhpExpr varExpression) {
    ...
    /**
     * Retrieves the PHP expression for a given variable name. The stack is traversed from top to
