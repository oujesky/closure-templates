...
/**
 * Value class to represent a PHP expression. Includes the text of the expression as well as the
 * precedence of the top-most operator.
 *
 * <p> Important: This class may only be used in implementing plugins (e.g. functions, directives).
 *
 * <p> Since the type information is rather generic it could potentially be shared with the JsExpr,
 * but as JS doesn't currently have any uses, and PHP types do differ in some aspects (such as
 ...
 *
 */
public class PhpExpr extends TargetExpr {

    /**
     * Create a new PHP expression with the given text and precedence.
     *
     ...
     */
    public PhpExpr(String text, int precedence) {
        super(text, precedence);
    }

    /**
     * Convert the given type to a PHP String expression.
     *
     * @return A PhpStringExpr representing this expression as a String.
     */
    public PhpStringExpr toPhpString() {
        return new PhpStringExpr(getText(), Integer.MAX_VALUE);
    }
}
