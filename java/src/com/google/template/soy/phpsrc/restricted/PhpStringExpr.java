...
/**
 * Value class to represent a PHP String expression. Includes the text of the expression as well
 * as the precedence of the top-most operator.
 *
 * <p> Important: This class may only be used in implementing plugins (e.g. functions, directives).
 *
 */
public final class PhpStringExpr extends PhpExpr {
     ...
     */
    public PhpStringExpr(String text) {
     ...
     */
    public PhpStringExpr(String text, int precedence) {
