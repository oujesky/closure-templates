...
/**
 * Interface for a Soy print directive implemented for the PHP Source backend.
 *
 * <p> Important: This may only be used in implementing print directive plugins.
 *
 */
public interface SoyPhpSrcPrintDirective extends SoyPrintDirective {
     ...
     * {@link com.google.template.soy.phpsrc.restricted.PhpExpr#toPhpString}.
     *
     ...
     */
    public PhpExpr applyForPhpSrc(PhpExpr value, List<PhpExpr> args);
