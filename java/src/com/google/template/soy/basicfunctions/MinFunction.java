...
@Singleton
@SoyPureFunction
class MinFunction implements SoyJavaFunction, SoyJsSrcFunction, SoyPySrcFunction, SoyPhpSrcFunction {
  ...
  @Override public PhpExpr computeForPhpSrc(List<PhpExpr> args) {
    ...
    PhpFunctionExprBuilder fnBuilder = new PhpFunctionExprBuilder("min");
