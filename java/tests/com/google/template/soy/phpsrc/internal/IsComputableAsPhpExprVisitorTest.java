...
/**
 * Unit tests for IsComputableAsPhpExprVisitor.
 *
 */
public class IsComputableAsPhpExprVisitorTest extends TestCase {
    ...
    private static void runTestHelper(String soyNodeCode, boolean expectedResult) {
        ...
        assertThat(new IsComputableAsPhpExprVisitor(ExplodingErrorReporter.get()).exec(node))
